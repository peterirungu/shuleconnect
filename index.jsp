...
<link href="${contextPath}/assets/global/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
    <link rel="stylesheet" type="text/css" href="${contextPath}/assets/frontend/css/imagehover.min.css">
    <link rel="stylesheet" type="text/css" href="${contextPath}/assets/frontend/css/style.css">
  ...
  <body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        ...
        <a class="navbar-brand" href="index.html">shule<span>-Connect</span></a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
          <li><a href="#home">Home</a></li>
          <li><a href="#">About Us</a></li>
          <li><a href="#search">School Search</a></li>
          <li><a href="#contact">Contact Us</a></li>
          <li><a href="#" data-target="#login" data-toggle="modal">Sign in</a></li>
          <li class="btn-trial"><a href="subscription.jsp?view=1:0">Register School</a></li>
        </ul>
        </div>
      </div>
    </nav>
          ...
          <div class="row">
            <div class="banner-text text-center">
              <div class="text-border">
                <h2 class="text-dec">Connect and Digitize</h2>
              </div>
              <div class="intro-para text-center quote">
                ...
                <a href="#search" class="btn">Search For School</a>
              </div>
              <a href="#search" class="mouse-hover"><div class="mouse"></div></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id ="search" class="section-padding">
      ...
      <div class="container">
        <div class="row">
          <div class="header-section text-center">
            <h2>Choose School Search Category|Level</h2>   
          </div>    
          <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 urefu">
            <div class="offer offer-success">
              <div class="shape">
                <div class="shape-text"></div>
              </div>
              <div class="offer-content">
                <h3 class="lead">ECDE(s)</h3>           
                <!-- <p>(Early Childhood Development Education)</p> -->
              </div>
            </div>
          </div>      
          <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
            <div class="offer offer-success">
              <div class="shape">
                <div class="shape-text">8</div>
              </div>
              <div class="offer-content">
                <h3 class="lead">Primary Schools</h3>                
              </div>
            </div>
          </div>     
          <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
            <div class="offer offer-success">
              <div class="shape">
                <div class="shape-text">4</div>
              </div>
              <div class="offer-content">
                <h3 class="lead">Universities</h3>                
              </div>
            </div>
          </div>     
          <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
          ...
          <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
            <div class="offer offer-success">
              ...
              <div class="offer-content">
                <h3 class="lead">Secondary Schools</h3>                
              </div>
            </div>
          </div>      
          <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
            <div class="offer offer-success">
              ...
              <div class="offer-content">
                <h3 class="lead">International Schools</h3>                
              </div>
            </div>
          </div>     
          <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
            <div class="offer offer-success">
              ...
              <div class="offer-content">
                <h3 class="lead">Vocation Education Schools</h3>                
              </div>
            </div>
          </div>    
          <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
            <div class="offer offer-success">
              ...
              <div class="offer-content">
                <h3 class="lead">Special|Intergrated Schools</h3>                
              </div>
            </div>
          </div>
        </div>
    ...
    <script src="${contextPath}/assets/frontend/js/jquery.min.js"></script>
    <script src="${contextPath}/assets/frontend/js/jquery.easing.min.js"></script>
    <script src="${contextPath}/assets/frontend/js/bootstrap.min.js"></script>
    <script src="${contextPath}/assets/frontend/js/custom.js"></script>
    <script src="${contextPath}/assets/frontend/contactform/contactform.js"></script>
