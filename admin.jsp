...
<c:set var="appRoot" value="heritage" />
<c:set var="mainPage" value="admin" scope="page" />
...
<%
	...
	String xmlcnf = request.getParameter("config_file");
	...
	web.init(request);
System.out.print(web.getUserID());
...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.jsp">
			<img src="./assets/logos/Heritage-Logo.jpeg" alt="logo" style="margin: 0px 10px 0 10px; width: 107px;" class="logo-default"/>
			</a>
			...
			<div class="row">
				<div class="col-md-12" >
					...
					<div class="portlet box <%= web.getViewColour() %>">
						...
						<%	} %>
						<% if(fieldTitles != null) { %>
							<table class="table" style="margin-bottom:0px; color:#fff;"><tr>
								<td ><%= fieldTitles %></td>
								<td >
